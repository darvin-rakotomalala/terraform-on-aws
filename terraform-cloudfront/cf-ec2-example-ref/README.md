...
In this repository, I’ll show an example how to integrate Amazon Content Delivery Networks (CDNs) CloudFront with websites hosted on EC2 instances using Terraform.
...
- Create an EC2 Web Server Instance in a VPC
