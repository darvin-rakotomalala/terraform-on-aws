...
// role = aws_iam_role.apigw_cloudwatch.arn
...
# Enable CloudWatch Logging on the aws_api_gateway_stage
################################################################################
...
resource "aws_cloudwatch_log_group" "api_gateway_execution_logs" {
  name              = "API-Gateway-Execution-Logs_${aws_api_gateway_rest_api.API-gateway.id}/${aws_api_gateway_stage.my-prod-stage.stage_name}"
